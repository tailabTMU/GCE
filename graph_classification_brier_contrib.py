        ...
        with tqdm(range(params['epochs'])) as t:
            for epoch in t:
                ...
                torch.save(model.state_dict(),
                           '{}.pkl'.format(pjoin(ckpt_dir, f"epoch_gamma_{gamma_txt}_{str(epoch)}")))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Training a Graph Classifier with Brier Score Loss')
