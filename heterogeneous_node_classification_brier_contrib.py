...
from utils.gnn import train_heterogeneous_node_classifier as train, test_heterogeneous_node_classifier as test, BrierScoreLoss
...
def main(gamma):
    ...
    if path.exists(pjoin(cwd, 'saved_info_heterogeneous_node_classification', f'brier_score')) is False:
        os.mkdir(pjoin(cwd, 'saved_info_heterogeneous_node_classification', f'brier_score'))
    ...
    criterion = BrierScoreLoss(num_classes=4, gamma=gamma, dynamic_gamma=False)
    ...
    with open(pjoin(cwd, 'saved_info_heterogeneous_node_classification', f'brier_score',
    ...
    torch.save(model.state_dict(),
               pjoin(cwd, 'saved_info_heterogeneous_node_classification', f'brier_score',
