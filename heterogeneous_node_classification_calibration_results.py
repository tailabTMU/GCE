...
def main():
    ...
    for model in models:
        ...
        for calibration_method in ['uncalibrated', 'gcl', 'brier_score']:
            results = []
            results_dir = pjoin(cwd, 'saved_info_heterogeneous_node_classification', f'{calibration_method}')
                ...
                for file_suffix in file_suffixes:
                    ...
                    if info != '':
                        ...
                        if info == 'dynamic_gamma':
                            ...
                            info = f'Gamma: {info}'
                    print(
                        f'Model: {model_names[model]}, Calibration Method: {calibration_method.title().replace("_", "")}, Extra Info.: {info}')
                    print(
                        '====================================================================================')
                    print()
        ...
        with pd.ExcelWriter(pjoin(cwd, 'saved_info_heterogeneous_node_classification', f'results.xlsx')) as writer:
