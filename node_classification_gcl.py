...
from utils.gnn import train_node_classifier as train, test_node_classifier as test, GraphCalibrationLoss
...
def main(args, gamma):
    ...
    if path.exists(pjoin(cwd, 'saved_info_node_classification', f'gcl_{args.dataset.lower()}')) is False:
        os.mkdir(pjoin(cwd, 'saved_info_node_classification', f'gcl_{args.dataset.lower()}'))
    ...
    with open(pjoin(cwd, 'saved_info_node_classification', f'gcl_{args.dataset.lower()}',
    ...
    torch.save(model.state_dict(),
               pjoin(cwd, 'saved_info_node_classification', f'gcl_{args.dataset.lower()}',
